 ...
 * 2024.11. 22.		김혜준			VP credentialSubject 추출 로직 OutOfBounds 오류 수정
 */
...
//		profile.setCallBackUrl(svc.getCallBackUrl());
	...
	public Boolean verifyVP(String trxcode, VP vp) throws SpException {
		...
		// VP 정보 추출 및 저장
		if(result) {
			Map<String, Object> credentialSubject = (Map<String, Object>) verifiableCredentialList.get(2).get("credentialSubject");
